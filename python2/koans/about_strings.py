...
"""
    ...
    def test_escaping_quotes_at_the_end_of_triple_quoted_string(self):
        string = """Hello "world\""""
        self.assertEqual('Hello "world\"', string) # 这个很疑惑
    ...
    def test_adjacent_strings_are_concatenated_automatically(self):
        string = "Hello" ", " "world" # 这个厉害啊
        self.assertEqual("Hello, world", string)

    def test_plus_will_not_modify_original_strings(self): # 这个很奇怪 =_= 看错了，应该是 not modify
        hi = "Hello, "
        there = "world"
        string = hi + there
    ...
    def test_plus_equals_also_leaves_original_string_unmodified(self):
        ...
        there = "world"
        hi += there
        self.assertEqual("Hello, ", original) # 这个应该变的才对，因为是引用
